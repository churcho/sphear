defmodule MatxWeb.Accounts.SessionControllerTest do
  @moduledoc """
  ...
  describe "MatxWeb.Accounts.SessionController.create/2" do
    @tag :skip
    ...
    @tag :skip
    test "MatxWeb.Accounts.SessionController.delete/2", %{session_conn: session_conn, user: user} do
      conn =
        session_conn
        |> login(user)
        |> delete(@logout_route)
