defmodule SynapsWeb.UserAuthTest do
  use SynapsWeb.ConnCase, async: true

  alias Db.Accounts
  alias SynapsWeb.UserAuth
  import Db.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SynapsWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SynapsWeb.Endpoint.subscribe(live_socket_id)
